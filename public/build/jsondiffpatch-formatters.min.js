! function(e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), (f.jsondiffpatch || (f.jsondiffpatch = {})).formatters = e()
    }
}(function() {
    ...
    return (function e(t, n, r) {
        ...
        3: [function(require, module, exports) {
            var base = require("./base"),
                BaseFormatter = base.BaseFormatter,
                AnnotatedFormatter = function() {
            ...
            }, AnnotatedFormatter.prototype.format_unchanged = function() {}, AnnotatedFormatter.prototype.format_movedestination = function() {}, AnnotatedFormatter.prototype.format_node = function(t, e, n) {
            ...
            var wrapPropertyName = function(t) {
                ...
                formatAnyChange = function(t, e) {
                    var n = this.getDeltaType(e),
                        o = deltaAnnotations[n],
                        r = o && o.apply(o, Array.prototype.slice.call(arguments, 1)),
        ...
        4: [function(require, module, exports) {
            ...
            BaseFormatter.prototype.format = function(e, t) {
                ...
                var f = t && a,
                    s = f ? a.value : r;
                if ("undefined" == typeof t && "undefined" == typeof o) return void 0;
                var u = this.getDeltaType(t, a),
                    p = "node" === u ? "a" === t._t ? "array" : "object" : "";
                ...
                try {
                    ...
                    this.typeFormattterErrorFormatter(e, d, t, s, o, n, a), "undefined" != typeof console && console.error && console.error(d.stack)
                }
                ...
                var o, n = getObjectKeys(e),
                    a = "a" === e._t,
                    i = {};
                if ("undefined" != typeof t)
                    for (o in t) "undefined" != typeof e[o] || a && "undefined" != typeof e["_" + o] || n.push(o);
                for (o in e) {
                    var f = e[o];
                    isArray(f) && 3 === f[2] && (i[f[1].toString()] = {
                        key: o,
                        value: t[parseInt(o.substr(1))]
                ...
                for (var s = 0, u = n.length; u > s; s++) {
                    var p = n[s];
                    if (!a || "_t" !== p) {
                        var y = a ? "number" == typeof p ? p : parseInt(trimUnderscore(p), 10) : p,
                            d = s === u - 1;
                        r(p, y, i[y], d)
                    }
                }
                ...
                for (var t = [], r = e.split("\n@@ "), o = 0, n = r.length; n > o; o++) {
                    ...
                    for (var s = a.split("\n").slice(1), u = 0, p = s.length; p > u; u++) {
                        ...
                        if (y.length) {
                            ...
                            "+" === y.substr(0, 1) ? d.type = "added" : "-" === y.substr(0, 1) && (d.type = "deleted"), d.text = y.slice(1), i.pieces.push(d)
                        }
                    }
                    t.push(i)
                }
        ...
        5: [function(require, module, exports) {
            ...
            HtmlFormatter.prototype = new BaseFormatter, HtmlFormatter.prototype.typeFormattterErrorFormatter = function(t, e) {
                ...
                t.out("<pre>" + JSON.stringify(e, null, 2) + "</pre>")
            ...
            var adjustArrows = function(t) {
                ...
                var e = function(t) {
                    ...
                    o = function(t, e, o) {
                        for (var r = t.querySelectorAll(e), a = 0, i = r.length; i > a; a++) o(r[a])
                    },
                    r = function(t, e) {
                        for (var o = 0, r = t.children.length; r > o; o++) e(t.children[o], o)
                    };
                o(t, ".jsondiffpatch-arrow", function(t) {
                    ...
                    var n, s = e(o.querySelector(".jsondiffpatch-moved-destination")),
                        d = o.parentNode;
                    if (r(d, function(t) {
                            t.getAttribute("data-key") === s && (n = t)
                        }), n) try {
                        var f = n.offsetTop - o.offsetTop;
                        a.setAttribute("height", Math.abs(f) + 6), t.style.top = -8 + (f > 0 ? 0 : f) + "px";
                        var l = f > 0 ? "M30,0 Q-10," + Math.round(f / 2) + " 26," + (f - 4) : "M30," + -f + " Q-10," + Math.round(-f / 2) + " 26,4";
                        i.setAttribute("d", l), a.style.display = ""
                    } catch (c) {
                        return
                    }
                })
            ...
            HtmlFormatter.prototype.rootBegin = function(t, e, o) {
                var r = "jsondiffpatch-" + e + (o ? " jsondiffpatch-child-node-type-" + o : "");
            ...
            }, HtmlFormatter.prototype.nodeBegin = function(t, e, o, r, a) {
                var i = "jsondiffpatch-" + r + (a ? " jsondiffpatch-child-node-type-" + a : "");
                ...
                t.out('<ul class="jsondiffpatch-node jsondiffpatch-node-type-' + r + '">'), this.formatDeltaChildren(t, e, o), t.out("</ul>")
        ...
        6: [function(require, module, exports) {
            ...
            if (exports.html = require("./html"), exports.annotated = require("./annotated"), !environment.isBrowser) {
...
//# sourceMappingURL=jsondiffpatch-formatters.min.js